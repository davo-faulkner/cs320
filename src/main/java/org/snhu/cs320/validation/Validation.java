...
public class Validation {
	...
	public static void validateNotNull(Object input, String label) throws 
		ValidationException {
		if (input == null) {
	...
	public static void validateNotBlank(String input, String label) throws 
		ValidationException {
	...
	public static void validateLength(String input, String label, int minLength, 
			int maxLength) throws ValidationException {
		if (input.length() < minLength || input.length() > maxLength) {
			throw new ValidationException(label + " must be at least " + minLength 
					+ " and no greater than " + maxLength 
					+ " characters in length");
		}
	}
	
	public static void validateNumeric(String input, String label) throws 
		ValidationException {
		if (input.matches(".*\\D+.*")) {
